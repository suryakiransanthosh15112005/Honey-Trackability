...
public class BeekeeperProfileRequest {

    @NotBlank(message = "KVIC ID is required")
    @Size(max = 50, message = "KVIC ID cannot exceed 50 characters")
    ...
    public BeekeeperProfileRequest() {
    }

    public BeekeeperProfileRequest(String kvicId, String name, String village, String photoUrl,
